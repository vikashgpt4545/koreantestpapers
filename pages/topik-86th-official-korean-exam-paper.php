...
$page_title = "86th Solved TOPIK Korean Exam Paper PDF";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "86th Solved TOPIK Korean Exam Paper PDF",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">86th Solved TOPIK Korean Exam Paper PDF</h1>
            <p class="hero-subtitle">
                Download official NIIED 86th solved TOPIK I and TOPIK II <strong>korean exam paper</strong> PDF archives complete with verified answer sheets, listening transcripts, and solved <strong>korean test papers</strong>.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: 86th Official Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🏆 86th Solved Paper Archive</h3>
                    <span class="tag-badge amber">86th Session</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>86th Solved TOPIK II Exam Paper</h4>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>88th Question Set TOPIK II Paper PDF</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE 86TH TOPIK PRACTICE
                    </div>
