...
$page_title = "2022 Previous Year EPS TOPIK Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "2022 Previous Year EPS TOPIK Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">2022 Previous Year EPS TOPIK Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Download solved 2022 previous year EPS TOPIK <strong>korean exam paper</strong> PDF sets complete with official HRD Korea answer keys, listening transcripts, and solved <strong>korean test papers</strong>.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: 2022 Paper Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>📜 2022 Previous Year Archive</h3>
                    <span class="tag-badge green">2022 Solved</span>
                </div>
                <div class="exam-nav-list">
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2023 Official EPS TOPIK Past Paper</h4>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2024 Solved EPS TOPIK Exam Paper</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE 2022 PRACTICE MOCK
                    </div>
