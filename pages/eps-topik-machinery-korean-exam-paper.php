...
$page_title = "EPS TOPIK Tools & Machinery Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Tools & Machinery Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Tools & Machinery Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master industrial factory tools and machinery terminology with official EPS TOPIK <strong>korean exam paper</strong> sets, complete with equipment operation guides, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Machinery Paper Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>⚙️ Tools & Machinery Paper Archive</h3>
                    <span class="tag-badge green">Factory Equipment</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Tools & Machinery Korean Exam Paper PDF</h4>
                            <p>Full 100-item factory tools & heavy machinery paper</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE MACHINERY TOOL QUIZ
                    </div>
