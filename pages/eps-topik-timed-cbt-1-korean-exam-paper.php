...
$page_title = "Real-time EPS TOPIK CBT 1 Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Real-time EPS TOPIK CBT 1 Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Real-time EPS TOPIK CBT 1 Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Experience authentic computer-based testing with official Real-time EPS TOPIK CBT 1 <strong>korean exam paper</strong> sets, complete with 50-minute timer simulation, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Timed CBT 1 Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>⏱ Timed CBT Set 1 Archive</h3>
                    <span class="tag-badge blue">Timed CBT 1</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Real-time EPS TOPIK CBT 1 Exam Paper PDF</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE TIMED CBT 1 SIMULATOR
                    </div>
