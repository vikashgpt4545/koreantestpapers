...
$page_title = "EPS TOPIK Reading 200 Questions Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Reading 200 Questions Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Reading 200 Questions Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master the reading section of the EPS exam with official EPS TOPIK Reading 200 Questions <strong>korean exam paper</strong> sets, featuring picture vocabulary, signboards, fill-in-the-blanks, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Reading 200 Questions Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>📖 Reading 200 Questions Archive</h3>
                    <span class="tag-badge cyan">Reading 200 Qs</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Reading 200 Questions Exam Paper PDF</h4>
                            <p>Full 200 solved reading items compilation</p>
                        </div>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            ...
                            <p>Full timed UBT simulation set with reading answers</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE READING QUIZ SIMULATOR
                    </div>
