...
$page_title = "TOPIK 2 Level 4 Practice Korean Exam Paper PDF";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK 2 Level 4 Practice Korean Exam Paper PDF",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK 2 Level 4 Practice Korean Exam Paper PDF</h1>
            <p class="hero-subtitle">
                Achieve TOPIK II Level 4 fluency with solved <strong>korean exam paper</strong> sets, news headline comprehension guides, Korean proverbs (속담) archives, and official NIIED <strong>korean test papers</strong>.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Level 4 Paper Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>📘 TOPIK II Level 4 Exam Archive</h3>
                    <span class="tag-badge amber">Level 4 Advanced</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK II Level 4 Practice Exam Paper</h4>
                            <p>Full 300-point test set with writing essay answers</p>
                        </div>
                        <a href="../pdf/topik-2-advanced-model.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>91st Official TOPIK II Level 4 Paper</h4>
                            <p>NIIED official session test paper & key</p>
                        </div>
                        <a href="../pdf/topik-91st-official-paper.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Korean Proverbs & Idioms Guide</h4>
                            <p>Essential 50 proverbs tested in Level 4 papers</p>
                        </div>
                        <a href="../pdf/topik-2-advanced-model.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE LEVEL 4 MOCK TEST
                    </div>
