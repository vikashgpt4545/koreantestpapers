...
$page_title = "TOPIK Listening Transcripts Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK Listening Transcripts Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK Listening Transcripts Korean Test Papers</h1>
            <p class="hero-subtitle">
                Master auditory Korean comprehension with official TOPIK listening transcript <strong>korean test papers</strong>, complete with line-by-line Hangul audio scripts, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Listening Transcript Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🎧 Listening Transcript Paper Archive</h3>
                    <span class="tag-badge amber">Listening Scripts</span>
                </div>
                <div class="exam-nav-list">
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK Reading Comprehension Exam Paper</h4>
                            <p>Official TOPIK reading passages & answer key</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE LISTENING SCRIPT QUIZ
                    </div>
