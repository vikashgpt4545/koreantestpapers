...
$page_title = "Online TOPIK Mock Test Set 5 Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Online TOPIK Mock Test Set 5 Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Online TOPIK Mock Test Set 5 Korean Test Papers</h1>
            <p class="hero-subtitle">
                Finalize your TOPIK exam preparation with official Online TOPIK Mock Test Set 5 <strong>korean test papers</strong>, complete with full-length reading, listening, and writing modules, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: TOPIK Mock Set 5 Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🎯 TOPIK Mock Test Set 5 Archive</h3>
                    <span class="tag-badge amber">TOPIK Mock 5</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Online TOPIK Mock Test Set 5 Paper PDF</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE TOPIK MOCK 5 SIMULATOR
                    </div>
