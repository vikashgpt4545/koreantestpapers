...
$page_title = "TOPIK Advanced Listening Level 5-6 Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK Advanced Listening Level 5-6 Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK Advanced Listening Level 5-6 Korean Test Papers</h1>
            <p class="hero-subtitle">
                Master native-speed academic and professional listening comprehension with official TOPIK Advanced Listening Level 5-6 <strong>korean test papers</strong>, featuring Q31-Q50 audio transcripts, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Advanced Listening Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🎧 TOPIK II Listening Level 5-6 Archive</h3>
                    <span class="tag-badge red">Advanced Level 5-6</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK Advanced Listening Level 5-6 Paper PDF</h4>
                            <p>Full Q31-Q50 academic audio script compilation</p>
                        </div>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            ...
                            <p>Advanced proverbs & body-part idioms guide</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE ADVANCED LISTENING SIMULATOR
                    </div>
