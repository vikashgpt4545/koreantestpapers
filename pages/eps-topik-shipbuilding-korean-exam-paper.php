...
$page_title = "EPS TOPIK Shipbuilding Field Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Shipbuilding Field Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Shipbuilding Field Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master South Korea's shipyard industry terminology with official EPS TOPIK shipbuilding field <strong>korean exam paper</strong> sets, complete with welding protocols, pipe fitting guides, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Shipbuilding Field Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🚢 Shipbuilding Field Paper Archive</h3>
                    <span class="tag-badge green">Shipbuilding Field</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Shipbuilding Field Paper PDF</h4>
                            <p>Full shipyard welding, painting & pipe fitting set</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE SHIPYARD QUIZ
                    </div>
