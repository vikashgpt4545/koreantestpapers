...
$page_title = "EPS TOPIK Philippines Practice Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Philippines Practice Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Philippines Practice Korean Test Papers</h1>
            <p class="hero-subtitle">
                Download official HRD Korea EPS TOPIK Philippines practice <strong>korean test papers</strong>, complete with UBT tablet practice tests, manufacturing & shipbuilding sector papers, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Philippines Practice Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🇵🇭 Philippines Practice Archive</h3>
                    <span class="tag-badge green">Philippines EPS Official</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Philippines Practice Paper PDF</h4>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Shipbuilding & Welding Exam Paper</h4>
                            <p>Shipbuilding & heavy machinery practice set</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE PHILIPPINES EPS SIMULATOR
                    </div>
