...
$page_title = "EPS TOPIK Manufacturing Sector Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Manufacturing Sector Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Manufacturing Sector Korean Test Papers</h1>
            <p class="hero-subtitle">
                Prepare for the HRD Korea E-9 Manufacturing Industry examination with solved <strong>korean test papers</strong>, factory safety signboards, machinery terminology guides, and official <strong>korean exam paper</strong> archives.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Manufacturing Sector Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🏭 Manufacturing Paper Archive</h3>
                    <span class="tag-badge green">Manufacturing E-9</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Manufacturing Industry Solved Paper</h4>
                            <p>Official 20-question sector paper with safety keys</p>
                        </div>
                        <a href="../pdf/eps-topik-manufacturing.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Factory Machinery & Safety Tool Guide</h4>
                            <p>200 Picture questions of factory tools & safety signs</p>
                        </div>
                        <a href="../pdf/eps-topik-official-question-bank.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2025 EPS TOPIK Special CBT Re-entry Set</h4>
                            <p>Solved special CBT re-entry manufacturing paper</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE MANUFACTURING CBT
                    </div>
