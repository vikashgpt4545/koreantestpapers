...
$page_title = "EPS TOPIK Thailand Solved Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Thailand Solved Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Thailand Solved Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Download official HRD Korea EPS TOPIK Thailand solved <strong>korean exam paper</strong> sets, complete with UBT tablet practice tests, manufacturing & agriculture sector papers, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Thailand Solved Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🇹🇭 Thailand Solved Archive</h3>
                    <span class="tag-badge green">Thailand EPS Official</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Thailand Solved Paper PDF</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE THAILAND EPS SIMULATOR
                    </div>
