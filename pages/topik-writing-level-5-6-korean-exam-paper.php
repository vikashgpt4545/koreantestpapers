...
$page_title = "TOPIK Advanced Writing Level 5-6 Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK Advanced Writing Level 5-6 Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK Advanced Writing Level 5-6 Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master advanced 600-word argumentative essay writing with official TOPIK Advanced Writing Level 5-6 <strong>korean exam paper</strong> sets, featuring Q54 essay frameworks, downloadable <strong>korean test papers</strong> PDFs, and NIIED scoring rubrics.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Advanced Writing Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>✍ TOPIK II Writing Level 5-6 Archive</h3>
                    <span class="tag-badge red">Advanced Writing</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK Advanced Writing Level 5-6 Paper PDF</h4>
                            <p>Full Q54 600-word essay framework & model set</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE ADVANCED WRITING SIMULATOR
                    </div>
