...
$page_title = "TOPIK Beginner Listening Level 1-2 Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK Beginner Listening Level 1-2 Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK Beginner Listening Level 1-2 Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master TOPIK I listening comprehension with official TOPIK Beginner Listening Level 1-2 <strong>korean exam paper</strong> sets, complete with 30-question audio scripts, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Beginner Listening Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🎧 TOPIK I Listening Level 1-2 Archive</h3>
                    <span class="tag-badge green">Beginner Level 1-2</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK Beginner Listening Level 1-2 Paper PDF</h4>
                            <p>Full 30-question listening audio script & paper set</p>
                        </div>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            ...
                            <p>Essential Level 1-2 vocabulary & listening roots</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE TOPIK I LISTENING SIMULATOR
                    </div>
