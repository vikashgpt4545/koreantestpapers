...
$page_title = "Online TOPIK Mock Test Set 2 Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Online TOPIK Mock Test Set 2 Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Online TOPIK Mock Test Set 2 Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Advance your exam readiness with official Online TOPIK Mock Test Set 2 <strong>korean exam paper</strong> sets, featuring full-length reading, listening, and writing modules, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: TOPIK Mock Set 2 Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🎯 TOPIK Mock Test Set 2 Archive</h3>
                    <span class="tag-badge amber">TOPIK Mock 2</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Online TOPIK Mock Test Set 2 Paper PDF</h4>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE TOPIK MOCK 2 SIMULATOR
                    </div>
