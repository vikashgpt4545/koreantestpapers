...
$page_title = "Basic Hangul Alphabet Practice Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Basic Hangul Alphabet Practice Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Basic Hangul Alphabet Practice Korean Test Papers</h1>
            <p class="hero-subtitle">
                Master the Korean writing system from scratch with basic Hangul alphabet practice <strong>korean test papers</strong>, complete with stroke order worksheets, Batchim sound rules, downloadable <strong>korean exam paper</strong> PDFs, and quizzes.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Hangul Alphabet Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🔤 Hangul Alphabet Paper Archive</h3>
                    <span class="tag-badge blue">Beginner Level</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Basic Hangul Alphabet Worksheet & Paper</h4>
                            <p>Full consonant, vowel & Batchim practice paper</p>
                        </div>
                        <a href="../pdf/hangul-alphabet-guide.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK 1 Level 1 Beginner Exam Paper</h4>
                            <p>Elementary level reading & listening test set</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE HANGUL ALPHABET QUIZ
                    </div>
