...
$page_title = "KIIP Korean Immigration Integration Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "KIIP Korean Immigration Integration Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">KIIP Korean Immigration Integration Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Prepare for South Korea's Ministry of Justice immigration exams with official KIIP (사회통합프로그램) <strong>korean exam paper</strong> sets, complete with placement test questions, Korean society & culture (한국사회 이해) guides, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: KIIP Program Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🏛 KIIP Immigration Integration Archive</h3>
                    <span class="tag-badge red">KIIP Program</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>KIIP Placement Test Paper PDF</h4>
                            <p>Full Level 0 to Level 5 evaluation paper set</p>
                        </div>
                        <a href="../pdf/topik-2-advanced-model.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Korean Society & Culture (한국사회 이해) PDF</h4>
                            <p>Level 5 naturalization & permanent residency guide</p>
                        </div>
                        <a href="../pdf/eps-topik-vocab.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>EPS TOPIK Grammar & Vocabulary Guide PDF</h4>
                            <p>Essential daily life & workplace Korean grammar</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE KIIP PLACEMENT SIMULATOR
                    </div>
