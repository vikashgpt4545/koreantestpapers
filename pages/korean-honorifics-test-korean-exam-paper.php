...
$page_title = "Korean Honorifics & Politeness Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Korean Honorifics & Politeness Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Korean Honorifics & Politeness Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master Korean workplace politeness levels and honorific expressions with official Korean honorifics <strong>korean exam paper</strong> sets, featuring formal speech drills, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Honorifics Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>👥 Honorifics & Politeness Archive</h3>
                    <span class="tag-badge green">Honorific Speech</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Korean Honorifics & Politeness Exam Paper PDF</h4>
                            <p>Full formal speech levels (-습니다) & honorific verbs set</p>
                        </div>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            ...
                            <p>Essential workplace verbs & polite noun equivalents</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE HONORIFICS QUIZ SIMULATOR
                    </div>
