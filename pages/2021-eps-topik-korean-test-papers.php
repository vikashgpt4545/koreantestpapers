...
$page_title = "2021 Practice Set EPS TOPIK Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "2021 Practice Set EPS TOPIK Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">2021 Practice Set EPS TOPIK Korean Test Papers</h1>
            <p class="hero-subtitle">
                Master baseline Korean language proficiency with solved 2021 practice set EPS TOPIK <strong>korean test papers</strong>, complete with official answer keys, listening transcripts, and downloadable <strong>korean exam paper</strong> archives.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: 2021 Paper Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>📜 2021 Practice Set Archive</h3>
                    <span class="tag-badge green">2021 Practice</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2021 Practice Set EPS TOPIK Test Paper</h4>
                            <p>Official 40-question test set with answer sheet</p>
                        </div>
                        <a href="../pdf/eps-topik-2021-past.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2022 Previous Year EPS TOPIK Exam Paper</h4>
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>2023 Official EPS TOPIK Past Paper PDF</h4>
                            <p>Official 2023 exam set with HRD answer sheet</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE 2021 MOCK TEST
                    </div>
