...
$page_title = "Korean Test Papers for HRD Korea Employment Seekers PDF & Solutions";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Korean Test Papers for HRD Korea Employment Seekers PDF & Solutions",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">Korean Test Papers for HRD Korea Employment Seekers PDF & Solutions</h1>
            <p class="hero-subtitle">
                Prepare for official HRD Korea work visa selection with targeted <strong>korean test papers</strong> designed specifically for job seekers, complete with industrial sector model tests, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Job Seeker Exam Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>👔 Job Seeker Exam Papers & Guidelines</h3>
                    <span class="tag-badge green">Employment Seekers</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>HRD Korea Job Seeker Korean Test Papers PDF</h4>
                            <p>Full 40-question model exam for E-9 work visa candidates</p>
                        </div>
                        <a href="../pdf/eps-topik-official-question-bank.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Manufacturing & Assembly Job Seeker Paper PDF</h4>
                            <p>Hand tools, machinery safety, and factory contract reading</p>
                        </div>
                        <a href="../pdf/eps-topik-manufacturing.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Agriculture & Construction Job Seeker Paper PDF</h4>
                            <p>Farming equipment, building sites, and weather term drills</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE JOB SEEKER CBT PRACTICE
                    </div>
