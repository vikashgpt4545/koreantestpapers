...
$page_title = "EPS TOPIK Picture & Image Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "EPS TOPIK Picture & Image Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">EPS TOPIK Picture & Image Korean Test Papers</h1>
            <p class="hero-subtitle">
                Master visual question identification with specialized EPS TOPIK picture and image <strong>korean test papers</strong>, featuring tool photos, workplace action illustrations, downloadable <strong>korean exam paper</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Image Question Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🖼 Image Question Paper Archive</h3>
                    <span class="tag-badge green">Visual Questions</span>
                </div>
                <div class="exam-nav-list">
                    ...
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Traffic Sign & Safety Signboard Paper</h4>
                            <p>Official industrial safety warning signs PDF</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE VISUAL QUESTION QUIZ
                    </div>
