...
$page_title = "TOPIK 2 Level 5 Advanced Korean Test Papers";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK 2 Level 5 Advanced Korean Test Papers",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK 2 Level 5 Advanced Korean Test Papers</h1>
            <p class="hero-subtitle">
                Achieve TOPIK II Level 5 advanced academic certification with solved <strong>korean test papers</strong>, Four-Character Idiom (사자성어) guides, research passage breakdowns, and official NIIED <strong>korean exam paper</strong> archives.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Level 5 Paper Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>🏛 TOPIK II Level 5 Exam Archive</h3>
                    <span class="tag-badge red" style="background: #dc2626;">Level 5 Advanced</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK II Level 5 Solved Academic Paper</h4>
                            <p>Full 300-point advanced reading, listening & essay set</p>
                        </div>
                        <a href="../pdf/topik-2-advanced-model.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>91st Official TOPIK II Advanced Paper</h4>
                            <p>Official 91st NIIED session advanced test paper</p>
                        </div>
                        <a href="../pdf/topik-91st-official-paper.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>Four-Character Idioms (사자성어) Archive</h4>
                            <p>Essential Sino-Korean 4-character idioms guide</p>
                        </div>
                        <a href="../pdf/topik-2-advanced-model.pdf" class="btn-download-sm" download>PDF</a>
                    </div>
                </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE ADVANCED PRACTICE
                    </div>
