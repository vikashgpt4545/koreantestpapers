...
$page_title = "TOPIK Reading Comprehension Korean Exam Paper";
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "TOPIK Reading Comprehension Korean Exam Paper",
...
<section class="hero-section">
    <div class="container">
        <div class="hero-heading-box">
            <h1 class="hero-title">TOPIK Reading Comprehension Korean Exam Paper</h1>
            <p class="hero-subtitle">
                Master TOPIK II Reading (읽기) passages with official <strong>korean exam paper</strong> sets, complete with speed reading blueprints, downloadable <strong>korean test papers</strong> PDFs, and answer keys.
            </p>
        </div>

        <!-- 2-Column Split Box Container -->
        <div class="hero-split-container">
            <!-- Left Box: Reading Comprehension Downloads -->
            <div class="hero-left-box">
                <div class="box-title-header">
                    <h3>📖 Reading Comprehension Archive</h3>
                    <span class="tag-badge amber">Reading Section</span>
                </div>
                <div class="exam-nav-list">
                    <div class="exam-item-card">
                        <div class="exam-item-info">
                            <h4>TOPIK Reading Comprehension Exam Paper</h4>
                            <p>Full 50-question reading passage & answer key set</p>
                        </div>
            ...
            <div class="hero-right-box" id="live-test-box">
                <div class="live-test-header">
                    <div class="live-indicator">
                        <span class="live-dot"></span> LIVE READING PASSAGE QUIZ
                    </div>
